...
class ShippingsControllerTest < ActionController::TestCase
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post :create, shipping: { entity_id: @shipping.entity_id, name: @shipping.name, user_id: @shipping.user_id }
    end
  ...
  test "should update shipping" do
    put :update, id: @shipping, shipping: { entity_id: @shipping.entity_id, name: @shipping.name, user_id: @shipping.user_id }
    assert_redirected_to shipping_path(assigns(:shipping))
  end
